...
public class DoanhThu {
    ...
    public DoanhThu(String maMonAn, String tenMonAn, String hinh, int giaBan, int sdt,String nguoiMua, String ngayThangNam) {
    ...
    public String Xuat() {
        String kq = maMonAn + "-" + tenMonAn + "-" + hinh + "-" + giaBan+"-"+sdt+"-"+nguoiMua+"-"+ngayThangNam;
        return kq;
    }
}
